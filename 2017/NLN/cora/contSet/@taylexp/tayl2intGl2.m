function res = tayl2intGl2(obj, var1, var2, eps)
% tayl2intGl2 - convert a taylor expression to an interval (object, var1, var2, eps)
...
for j = 1:obj.numberOfCells_j
    for i = 1:obj.numberOfCells_i
        ...
        rem11 = GInt2(var1, var2, new_claim, eps);
        rem1 = rem11(i,j);
