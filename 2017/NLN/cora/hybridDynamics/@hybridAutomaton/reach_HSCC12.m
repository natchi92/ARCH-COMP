...
%         finalIndex = finalIndex+1;
    ...
    %for HSCC'12 only!!!!
%     for iSet = 1:length(Rcont.OT)
%         Rcont.OT{iSet} = reduce(Rcont.OT{iSet},'girard',0.2*options.zonotopeOrder);
%         Rcont.T{iSet} = reduce(Rcont.T{iSet},'girard',0.2*options.zonotopeOrder);
%     end
