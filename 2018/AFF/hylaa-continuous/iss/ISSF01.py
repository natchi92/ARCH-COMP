...
if __name__ == '__main__':
    #run_hylaa(plot=True, limit=0.0007)

    s01 = run_hylaa(plot=False, limit=0.0007)
    print "Spec S01: Time={:.2f}sec, safe={}".format(s01.top_level_timer.total_secs, s01.safe)

    u01 = run_hylaa(plot=False, limit=0.0005)
    print "Spec U01: Time={:.2f}sec, safe={}".format(u01.top_level_timer.total_secs, u01.safe)
