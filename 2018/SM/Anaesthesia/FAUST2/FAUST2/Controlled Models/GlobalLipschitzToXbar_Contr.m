function [hbar] = GlobalLipschitzToXbar_Contr(KernelFunction,SafeSet,InputSet)

%GLOBALLIPSCHITZTOXBARCONTR Numerically computes the global Lipschitz constant
