function [X,U,E] = Uniform_grid_Contr(epsilon,KernelFunction,N,SafeSet,InputSet)
%UNIFORM_GRID_CONTR This function makes a uniform grid that will produce a
...
0.5*epsilon/(h_a*2*L_A*N)
0.5*epsilon/(h_u*2*L_A*N)
2*N*L_A*h_a,2*N*L_A*h_u
