...
function [X,U,E] = Adaptive_grid_ReachAvoid_semilocal_Contr(epsilon,KernelFunction,N,X,U,SafeSet,TargetSet,InputSet)
%Adaptive_grid_ReachAvoid_semilocal_Contr This function makes an adaptive grid that will
...
[h_ir] = SemiLocalLipschitz_Contr(KernelFunction,X,sum(TargetIndex)+1,m,U,1,q,SafeSet);

% The initial Lipschitz constants to u
[h_ir_u] = SemiLocalLipschitzToU_Contr(KernelFunction,X,sum(TargetIndex)+1,m,U,1,q,SafeSet);
