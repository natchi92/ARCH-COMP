function [h_ir] = SemiLocalLipschitz_Contr(KernelFunction,X,xl,xu,U,ul,uu,SafeSet)

%SEMILOCALLIPSCHITZ_CONTR Numerically computes the semi-local Lipschitz constants by
